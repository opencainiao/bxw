...
var data_manage_functions = {
	...
	delOne : function(data) {
		...
		var url_to = $.getSitePath() + '/backend/sysconsttype/' + data["_id_m"]
				+ '/delete';
	...
	toEdit : function(data) {
		...
		$.popUpWindow("编辑材料类型信息", url, "800px", "400px", "edit",
				$("#data_manage"));
	},
	/***************************************************************************
	 * 进入详细信息页面
...
var data_manage = {
	...
	search : function() {
		...
		url = $.getSitePath() + '/backend/sysconsttype/list?ts='
				+ new Date().getTime();
