...
<ul class="breadcrumb">
    <li><a href="<%=request.getContextPath()%>/backend/emailtype/list">邮箱类型管理</a> <span class="divider"></span></li>
    <li class="active">添加邮箱类型</li>
</ul>
<div id="add_div" class="onepage">
    <input type="hidden" name="_id" />
    <sf:form modelAttribute="emailtype" class="form-horizontal">
...
<script>
    ...
    var save = function() {
        ...
        var url_to = "<%=request.getContextPath()%>/backend/emailtype/add";
        var url_success = "<%=request.getContextPath()%>/backend/emailtype/list";
