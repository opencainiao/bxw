...
<div id="edit_div" class="onepage" style="margin-top: 30px">
    <input type="hidden" name="_id" value="${emailtype._id}"/>
    <sf:form modelAttribute="emailtype" class="form-horizontal center-block " style="width: 500px">
  			<div class="form-group ">
	            <label for="owner_user_id" class="col-sm-3 control-label">
	                所属用户id
	            </label>
	            <div class="col-sm-8">
	                <input type="text" class="form-control" id="owner_user_id" name="owner_user_id" value="${emailtype.owner_user_id}"  placeholder="" >
	            </div>
	        </div>
  			<div class="form-group ">
	            ...
	            <div class="col-sm-8">
	                <input type="text" class="form-control" id="type_value" name="type_value" value="${emailtype.type_value}"  placeholder="" >
	            </div>
	        </div>
  			<div class="form-group ">
	            ...
	            <div class="col-sm-8">
	                <input type="text" class="form-control" id="type_name" name="type_name" value="${emailtype.type_name}"  placeholder="" >
	            </div>
	        </div>
  			<div class="form-group ">
	            ...
	            <div class="col-sm-8">
	                <input type="text" class="form-control" id="type_character" name="type_character" value="${emailtype.type_character}"  placeholder="" >
	            </div>
	        </div>
