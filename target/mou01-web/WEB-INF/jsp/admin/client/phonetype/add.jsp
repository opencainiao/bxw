...
<ul class="breadcrumb">
    <li><a href="<%=request.getContextPath()%>/backend/phonetype/list">手机类型管理</a> <span class="divider"></span></li>
    <li class="active">添加手机类型</li>
</ul>
<div id="add_div" class="onepage">
    <input type="hidden" name="_id" />
    <sf:form modelAttribute="phonetype" class="form-horizontal">
...
<script>
    ...
    var save = function() {
        ...
        var url_to = "<%=request.getContextPath()%>/backend/phonetype/add";
        var url_success = "<%=request.getContextPath()%>/backend/phonetype/list";
