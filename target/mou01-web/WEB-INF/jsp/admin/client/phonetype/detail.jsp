...
<body>
	<div class="container-fluid inlineone" style="margin-top: 30px">
		<div class="col form-horizontal center-block " style="width: 400px">
				...
				<div class="form-group ">
					<label for="type_value" class="col-sm-3 control-label"> 电话类型值 </label>
					<div>
				...
				<div class="form-group ">
					<label for="type_name" class="col-sm-3 control-label"> 电话类型名称 </label>
					<div>
				...
				<div class="form-group ">
					<label for="type_character" class="col-sm-3 control-label"> 电话类型性质 </label>
					<div>
