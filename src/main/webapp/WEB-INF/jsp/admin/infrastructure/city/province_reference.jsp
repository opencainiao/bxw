	...
	<script>
		...
		var province_functions = {
			...
			confirm_choose_unit : function() {
				...
				window.top.setProvince(item_choosed);
				window.top.closeChoose_provinceWindow();
			}
		};
		...
		var province_search = {
			...
			search : function() {
				...
				province_search.gridsetting.url = $.getSitePath() + '/backend/city/list_by_pid?ts=' + new Date().getTime();
