...
<body>
	<form id="upload_form" enctype="multipart/form-data">
		...
		<div class="input-group" style="padding: 8px; padding-left: 10px">
			<input type="file" name="image_file" id="image_file" 
				style="width: 88px; text-align: left;" onChange=fileSelectHandler() class="pull-left"
	...
	<script>
		...
		function uploadFile() {
			...
			xhr.open("POST", "${ctx}/front/client/${client_id}/upload_visiting_card_img");
		...
		function uploadComplete(evt) {
			...
			if (data['success'] == 'n') {
				...
				parent.showVisitIngCards();
				parent.closeUpload_Visiting_Card_Img();
			}
		}
