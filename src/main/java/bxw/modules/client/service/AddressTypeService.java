...
public class AddressTypeService extends BaseService implements IAddressTypeService {

	@Resource(name = "commonDaoMongo")
	private IBaseDaoMongo commonDaoMongo;

	private static final Logger logger = LogManager.getLogger(AddressTypeService.class);
